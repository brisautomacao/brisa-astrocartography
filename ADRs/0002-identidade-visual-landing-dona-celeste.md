...
- **Carta coerente com a tríade (Adriana, 2026-09-01)**: os pontos da carta (página e cartão) passam a corresponder ao texto de exemplo: SOL no setor de Leão, LUA no de Escorpião e marcador ASC no de Peixes; demais planetas espalhados. No MVP 1 as posições saem do cálculo real e a coerência é automática.
