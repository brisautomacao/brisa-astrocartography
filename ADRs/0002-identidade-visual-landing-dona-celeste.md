...
- **Carta coerente com a tríade (Adriana, 2026-09-01)**: os pontos da carta (página e cartão) passam a corresponder ao texto de exemplo: SOL no setor de Leão, LUA no de Escorpião e marcador ASC no de Peixes; demais planetas espalhados. Aspectos redesenhados como **cordas que cruzam o centro (teia)**, sem ligações coladas na borda e sem ligar o marcador ASC (Adriana: "as linhas tinham que se cruzar"). No MVP 1 as posições saem do cálculo real e a coerência é automática.
