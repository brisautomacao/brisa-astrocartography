...
| [0003](0003-frente1-captura-de-lead-whatsapp-brisadocs.md) | Frente 1: captura de lead com WhatsApp via API pública do brisadocs (SQLite no PVC, aba /painel/leads) | Aceito (parcialmente suspenso por ADR-0005 em 02/09/2026) |
...
| [0005](0005-monetizacao-stripe-pausa-whatsapp.md) | Monetização com Stripe Payment Links (R$ 9,90 / R$ 29,90), UX para público mais velho, pausa da captura de WhatsApp | Aceito |
